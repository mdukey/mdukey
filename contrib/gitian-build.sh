...
DEFAULT_GAIA_SIGS=${GAIA_SIGS:-'mdukey.sigs'}
DEFAULT_GITIAN_REPO='https://github.com/tendermint/gitian-builder'
DEFAULT_GBUILD_FLAGS=''
DEFAULT_SIGS_REPO='https://github.com/cosmos/mdukey.sigs'
...
f_build() {
  ...
  bin/gbuild --commit mdukey="$g_commit" ${GBUILD_FLAGS} "$l_descriptor"
