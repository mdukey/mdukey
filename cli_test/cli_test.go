...
func TestMdukeyCLIKeysAddMultisig(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestMdukeyCLIKeysAddRecover(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestMdukeyCLIKeysAddRecoverHDPath(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestMdukeyCLIMinimumFees(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)

	// start mdukeyd server with minimum fees
...
func TestMdukeyCLIGasPrices(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestMdukeyCLIFeesDeduction(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestMdukeyCLISend(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestMdukeyCLIGasAuto(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestMdukeyCLICreateValidator(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestMdukeyCLIQueryRewards(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
	cdc := app.MakeCodec()
	...
	genFile := filepath.Join(f.MdukeydHome, "config", "genesis.json")
...
func TestMdukeyCLIQuerySupply(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestMdukeyCLISubmitProposal(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestMdukeyCLISubmitParamChangeProposal(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestMdukeyCLISubmitCommunityPoolSpendProposal(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestMdukeyCLIQueryTxPagination(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestMdukeyCLIValidateSignatures(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestMdukeyCLISendGenerateSignAndBroadcast(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestMdukeyCLIMultisignInsufficientCosigners(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestMdukeyCLIEncode(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestMdukeyCLIMultisignSortSignatures(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestMdukeyCLIMultisign(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestMdukeyCLIConfig(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
	...
	config, err := ioutil.ReadFile(path.Join(f.MdukeycliHome, "config", "config.toml"))
	require.NoError(t, err)
...
func TestMdukeydCollectGentxs(t *testing.T) {
	t.Parallel()
...
func TestMdukeydAddGenesisAccount(t *testing.T) {
	t.Parallel()
	f := NewFixtures(t)
