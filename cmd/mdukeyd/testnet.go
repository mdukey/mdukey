...
func testnetCmd(ctx *server.Context, cdc *codec.Codec,
	...
	cmd := &cobra.Command{
		Use:   "testnet",
		Short: "Initialize files for a Mdukeyd testnet",
...
Example:
	mdukeyd testnet --v 4 --output-dir ./output --starting-ip-address 192.168.10.2
	`,
	...
	cmd.Flags().String(flagNodeDaemonHome, "mdukeyd",
		"Home directory of the node's daemon configuration")
	cmd.Flags().String(flagNodeCLIHome, "mdukeycli",
...
func InitTestnet(cmd *cobra.Command, config *tmconfig.Config, cdc *codec.Codec,
	...
	mdukeyConfig := srvconfig.DefaultConfig()
	mdukeyConfig.MinGasPrices = minGasPrices
	...
	for i := 0; i < numValidators; i++ {
		...
		// TODO: Rename config file to server.toml as it's not particular to Mdukey
		// (REF: https://github.com/cosmos/cosmos-sdk/issues/4125).
		mdukeyConfigFilePath := filepath.Join(nodeDir, "config/mdukeyd.toml")
		srvconfig.WriteConfigFile(mdukeyConfigFilePath, mdukeyConfig)
	}
