...
import (
	...
	mdukey "github.com/mdukey/mdukey/app"
)
...
func runHackCmd(cmd *cobra.Command, args []string) error {
	...
	db, err := sdk.NewLevelDB("mdukey", dataDir)
	if err != nil {
		fmt.Println(err)
		os.Exit(1)
	}
	app, keyMain, keyStaking, stakingKeeper := mdukey.NewMdukeyAppUNSAFE(
